...
\begin{alignat}{2}
	\var^{-1}(d)
	&\geq\frac{I_{11}^2-I_{12}^2}{2(I_{11}+I_{12})}\\
	&\geq\frac{1}{2}\left(I_{11}-I_{12}\right)
\end{alignat}
%
From  \autoref{eq:app-Fisher Information alternative - Individual} we get
\begin{alignat}{2}
	\var^{-1}(d)
	&\geq\frac{\Lambda}{2}\sum_k\left[\frac{\left(q'_k(c_1)\right)^2-q'_k(c_1)q'_k(c_2)}{q_k(c_1)+q_k(c_2)+b/\Lambda} \right]\\
	&\geq\frac{\Lambda}{4}\sum_k\left[\frac{\left(q'_k(c_1)-q'_k(c_2)\right)^2}{q_k(c_1)+q_k(c_2)+b/\Lambda} \right],
	\label{eq:app-equivalence FREM orig and us}
\end{alignat}
% 
