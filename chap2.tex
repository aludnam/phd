...
\begin{figure}[!bh]
	...
	\newcommand{\wf}{.48\textwidth}
	\subfloat[b=100]{
	\includegraphics[width=\wf]{\qd gFREM/images/FREMdip_Lambda500_b100}
	\label{fig:FREM dip}}
	\subfloat[b=0]{
	\includegraphics[width=\wf]{\qd gFREM/images/FREMdip_Lambda500_b0}
