...
\begin{figure}[!hbt]
	...
	\subfloat[Static - top view]{\includegraphics[width=\wf]{\qd gFREM/images/FREM_Static_flat_sep40fix}}
	\subfloat[Blinking - top view]{\includegraphics[width=\wf]{\qd gFREM/images/FREM_IntOut_flat_sep40fix}}
...
%		\hline	
%	\end{tabular}
%	\caption{Illustration of a source with intensity $\Lambda$ and background level $b$ corrupted with Poisson noise. Red dot indicates the position of the source.}
...
%	\centering
%	\newcommand{\wf}{.2\textwidth}
%	\newcommand{\dirim}{\qd gFREM/images/psf/twosources_}
%	\newcommand{\vs}{.5}
%	\begin{tabular}{|ccccc}
%		\begin{sideways}\hspace{\vs cm}$\Lambda=5000$\end{sideways}
%		&\includegraphics[width=\wf]{\dirim int5000_bg0}
...
%		\hline	
%	\end{tabular}
%	\caption{Illustration of two sources with intensity $\Lambda$ and background level $b$ corrupted with Poisson noise. Red dots indicate the positions of the sources.}
%	\label{fig:two sources int bg}
%\end{figure}
