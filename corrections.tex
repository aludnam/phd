...
blank spaces and addition of text.
\\
\\
...
- I added this not to the text of the thesis in section 2.7.2.
...
- For simulated data, where the true sources are known, I definded a ``crediblity index" as a maximum of the dot product between the estimated source and the true sources normalised to the $L_2$ norm of the true and the estimated source (Eq. 2.21). I added Fig. 2.22 showning the correlation between the ``credibility index" and the $L_2$ norm. This indicates that $L_2$ norm is a good measure of ``credibility". I commented on towards the end of section 2.7.4.
...
\tc{P83 [new P86] Please talk me through how arbitrary this is, and how close to 'optimal' is possible.}
...
- I added not on this in section 3.8.6.
...
\tc{P84 “an area of the kth pixel $\rightarrow$ the region of the kth pixel. }
-  Fixed.
...
- To approximate the continuous PSF recorded on the pixelised grid (mentioned in the text in sec. 3.6).
...
- The accuracy of the result (estimation of the distance between the two sources) relates to FREM as FREM specify the standard deviation of the estimator. The pixellation it taken into account through Eq. 3.11.
...
- I added not in this in Appendix A. 
