...
thank you for the feedback to my PhD thesis. I addressed all the points in the provided list of corrections and specified what and where I changed. The biggest changes are in section 2.4  "Related work" were I added a whole subsection referring to the different use of NMF in biology and microscopy. Note that page numbers might be different to the originally submitted document. This is due to removal of larger blank spaces and addition of text. 
\\
\\
