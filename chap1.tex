...
\end{equation}
%
The mean nearest neighbour distance corresponding to density $\rho$ of randomly scattered sources used for our simulations (see \autoref{sub:results - comparison}) are summarised in the following table:
%
\begin{table}[!h]
	\centering
