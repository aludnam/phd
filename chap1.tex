...
\begin{figure}[!htb]
	...
	\caption{Illlustration of the ``robustness'' of the \autoref{alg:restarts}  for different number of overestimated sources $K$.}
\end{figure}
