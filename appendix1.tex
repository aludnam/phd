...
The classic NMF updates \cite{Lee2001} minimise the generalised KL divergence between the data matrix $\bm{D}$ and its factorised version $\bm{WH}$ (see \autoref{eq:KL divergence})
%
\begin{equation}
